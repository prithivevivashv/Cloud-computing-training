...
- Provides external access using Minikube Tunnel or a cloud provider.
...
1. Developed the Hospital Web Application using Python (Flask).
...
8. Configured a ClusterIP Service.
9. Configured a NodePort Service.
10. Configured a LoadBalancer Service.
11. Created a ConfigMap for application configuration.
12. Created a Secret for sensitive information.
13. Created a Persistent Volume for storage.
...
- Hospital Web Application deployed successfully on Kubernetes.
- Pods running successfully.
- Services created successfully.
- Application accessible through NodePort and LoadBalancer.
